/**
 * Studio Noir — Figma design behaviour, merged into the main app bundle.
 * Ported from the standalone src/js/site.js. Dependency-light: Lenis smooth
 * scroll + vanilla FAQ accordion, mobile nav, header scroll state, scroll
 * reveal, the glow blob and the features scroll-track. Exposed as a single
 * `figmaSite()` initialiser that app.js calls on DOMContentLoaded.
 */
